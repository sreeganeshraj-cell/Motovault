        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subscriptions_StorageSlots_SlotId",
                        column: x => x.SlotId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceLogs_Subscriptions_SubscriptionId",
                        column: x => x.SubscriptionId,
                        principalTable: "Subscriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceLogs_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ServiceLogId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceMedia_ServiceLogs_ServiceLogId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceLogs_CreatedBy",
                table: "ServiceLogs",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceLogs_SubscriptionId",
                table: "ServiceLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceMedia_ServiceLogId",
                table: "ServiceMedia",
                column: "ServiceLogId");

            migrationBuilder.CreateIndex(
                name: "IX_StorageSlots_SlotNumber_Type",
                table: "StorageSlots",
                columns: new[] { "SlotNumber", "Type" },
                unique: true);
