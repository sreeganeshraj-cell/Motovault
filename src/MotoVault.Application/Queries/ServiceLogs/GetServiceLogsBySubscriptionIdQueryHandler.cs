...
public class GetServiceLogsBySubscriptionIdQueryHandler : IRequestHandler<GetServiceLogsBySubscriptionIdQuery, IEnumerable<ServiceLogResponse>>
{
    private readonly IDbConnectionFactory _connectionFactory;

    public GetServiceLogsBySubscriptionIdQueryHandler(IDbConnectionFactory connectionFactory)
    {
        _connectionFactory = connectionFactory;
    }

    public async Task<IEnumerable<ServiceLogResponse>> Handle(GetServiceLogsBySubscriptionIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return await connection.QueryAsync<ServiceLogResponse>(sql, new { request.SubscriptionId });
    }
}
