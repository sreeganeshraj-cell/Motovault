...
public class GetSubscriptionsByVehicleIdQueryHandler : IRequestHandler<GetSubscriptionsByVehicleIdQuery, IEnumerable<SubscriptionResponse>>
{
    private readonly IDbConnectionFactory _connectionFactory;

    public GetSubscriptionsByVehicleIdQueryHandler(IDbConnectionFactory connectionFactory)
    {
        _connectionFactory = connectionFactory;
    }

    public async Task<IEnumerable<SubscriptionResponse>> Handle(GetSubscriptionsByVehicleIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return await connection.QueryAsync<SubscriptionResponse>(sql, new { request.VehicleId });
    }
}
